...
public class @XRIDefaultInputActions : IInputActionCollection, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""HitTrigger"",
                    ""type"": ""Button"",
                    ""id"": ""1671bf0e-fe7e-49c8-acf0-638ee74df73a"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""ba1cf97b-0e17-432a-a369-d86919417561"",
                    ""path"": ""<XRController>{LeftHand}/triggerPressed"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHand_HitTrigger = m_XRILeftHand.FindAction("HitTrigger", throwIfNotFound: true);
        // XRI RightHand
    ...
    private readonly InputAction m_XRILeftHand_HitTrigger;
    public struct XRILeftHandActions
    {
        ...
        public InputAction @HitTrigger => m_Wrapper.m_XRILeftHand_HitTrigger;
        ...
        public void SetCallbacks(IXRILeftHandActions instance)
        {
            if (m_Wrapper.m_XRILeftHandActionsCallbackInterface != null)
            {
                ...
                @HitTrigger.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnHitTrigger;
                @HitTrigger.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnHitTrigger;
                @HitTrigger.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnHitTrigger;
            }
            ...
            if (instance != null)
            {
                ...
                @HitTrigger.started += instance.OnHitTrigger;
                @HitTrigger.performed += instance.OnHitTrigger;
                @HitTrigger.canceled += instance.OnHitTrigger;
            }
        }
    }
    ...
    public interface IXRILeftHandActions
    {
        ...
        void OnHitTrigger(InputAction.CallbackContext context);
    }
